...
5. You might instead want to run your own private version of the network for testing. To do this:
   ...
   3. Back in the alert-bot directory, instead of `npm start`, do `npm run local`, which publishes to the network on localhost, and you can visit through the Web page at [`http://localhost:3000/?dht=1`](http://localhost:3000/?dht=1).
